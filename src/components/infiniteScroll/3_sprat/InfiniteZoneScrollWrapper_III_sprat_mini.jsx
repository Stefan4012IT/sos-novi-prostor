...
const InfiniteZoneScrollMobile_III_Sprat_mini = ({ zones }) => {
  ...
  return (
    <section
      ref={wrapperRef}
      className="infinite-zone-mobile-wrapper III-sprat mobile"
...
export default InfiniteZoneScrollMobile_III_Sprat_mini;
