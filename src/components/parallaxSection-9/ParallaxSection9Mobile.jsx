  ...
  return (
    <section className="section-9 mobile">
      ...
      <div className="text_2">
        ...
        <p>
          Savremena ne raste slučajno – raste planski, sa ciljem da svakom
          učeniku pruži prostor u kojem može da uči, razmišlja, pita, stvara:
          na četiri sprata, sedam novih zona i bezbroj novih mogućnosti.
        </p>
      </div>
