...
const InfiniteZoneScrollMobile_II_Sprat_mini = ({ zones }) => {
  ...
  return (
    <section
      ref={wrapperRef}
      className="infinite-zone-mobile-wrapper II-sprat mobile"
...
export default InfiniteZoneScrollMobile_II_Sprat_mini;
